...
try {
    if (isset($_POST['username'], $_POST['title'], $_POST['company'], $_POST['url'], $_POST['date'])) {
        ...
        $channel->queue_declare('saveApplication', false, false, false, false);
        ...
        $channel->basic_publish($msg, '', 'saveApplication');

        $responseQueue = 'responseSaveApplication';
